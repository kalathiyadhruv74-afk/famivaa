...
SECRET_KEY = os.getenv('SECRET_KEY', 'famivaa-default-insecure-secret-key-2026-production-ready')
...
ROOT_URLCONF = 'femiva_backend.urls'
...
if DB_ENGINE:
    DATABASES = {
        'default': {
            'ENGINE': DB_ENGINE,
            'NAME': os.getenv('DB_NAME', 'famivaa_db'),
